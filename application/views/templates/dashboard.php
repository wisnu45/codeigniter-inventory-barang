...
<head>
    ...
    <title><?= $title; ?> | Aplikasi G-Inventori</title>
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="<?= base_url('dashboard'); ?>">
                ...
                <div class="sidebar-brand-icon">
                  ...
                  <i aria-hidden="true"><img src="<?= base_url(); ?>assets/img/admin.png" width="50"></i>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('satuan'); ?>">Item Unit</a>
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Types</a>
                        <a class="collapse-item" href="<?= base_url('gudang'); ?>">Werehouse</a>
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Inventory</a>
                    </div>
                </div>
            </li>
